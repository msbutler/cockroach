...
//
// TODO(msbutler): to make this more performant, consider pulling some of this
// filtering into the original loop. Consider asserting uniqueness on a smaller key.
