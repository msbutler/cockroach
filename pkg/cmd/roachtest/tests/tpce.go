...
func initTPCESpec(ctx context.Context, t test.Test, c cluster.Cluster, loadNode,
	roachNodes option.NodeListOption) (*tpceSpec, error){
...
func (ts *tpceSpec) run(ctx context.Context, t test.Test,c cluster.Cluster, o tpceCmdOptions)  (install.RunResultDetails, error){
