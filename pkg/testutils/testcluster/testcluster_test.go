...
// Stats over 100 runs: max = 7.1s, min = 3.2s, avg = 6.3s, dev = 0.7s
// Disable EventLogging: Stats over 100 runs: max = 6.7s, min = 3.1s, avg = 6.0s, dev = 0.6s
func TestClusterStartNoTenant(t *testing.T) {
...
// Hard disable: Stats over 100 runs: max = 3.2s, min = 1.5s, avg = 2.8s, dev = 0.3s
...
// Hard Disable: Stats over 100 runs: max = 3.1s, min = 1.5s, avg = 2.6s, dev = 0.3s
...
// Hard disable: Stats over 100 runs: max = 2.5s, min = 1.2s, avg = 2.0s, dev = 0.2s
